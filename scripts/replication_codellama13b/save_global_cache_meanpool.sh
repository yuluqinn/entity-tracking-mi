...
#$ -l gpu_memory=40G
#$ -o logs/$JOB_ID_replication_codellama13b_save_global_meanpool.log
#$ -j y
#$ -m e
#$ -M yuluqinn24@gmail.com

# === CodeLlama-13B MEAN-POOL EXPERIMENT — global-probe cache ===
# Same include_empty condition as the last-token global cache, but representations are
# the MEAN over context tokens (description + operations, through the final period
# before "Box k contains"), BOS and query phrase excluded. Stored fp32.
