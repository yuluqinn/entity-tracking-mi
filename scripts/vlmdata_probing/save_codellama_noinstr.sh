...
# split of data/vlm-data-noinstr (30/30 scene split, 60-object vocabulary).
...
python probe_experiments/train_probe.py \
    ...
    --exclude_empty \
    --condition_on the \
    --checkpoint_root probe_experiments/probe_checkpoints/codellama-13b-vlmdata-noinstr/binary_the \
