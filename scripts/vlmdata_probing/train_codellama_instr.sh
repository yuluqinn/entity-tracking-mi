...
# === CodeLlama-13B probe training on data/vlm-data-instr ===
# Optional -v vars:
...
do
    python probe_experiments/train_probe.py \
        ...
        --exclude_empty \
        --condition_on the \
        --checkpoint_root probe_experiments/probe_checkpoints/codellama-13b-vlmdata-instr${CKPT_SUFFIX}/binary_the \
